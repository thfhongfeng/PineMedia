package com.pine.media.video.vm;
...
import com.pine.media.video.VpConstants;
    ...
    public void deleteMedia(VpFileBean fileBean) {
        ...
        if (mediaList.size() > 0) {
            ...
            for (int i = 0; i < mediaList.size(); i++) {
                if (mediaList.get(i).getMediaCode().equals(fileBean.getMediaCode())) {
                    pos = i;
                    break;
                }
            }
            if (pos > -1) {
                ...
                String nextMediaCode = null;
                if (mediaList.size() > 0) {
                    nextMediaCode = mediaList.get(pos % mediaList.size()).getMediaCode();
                }
