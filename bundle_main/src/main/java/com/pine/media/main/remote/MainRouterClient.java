package com.pine.media.main.remote;
...
public class MainRouterClient {
    ...
    public static void goBizHome(Context context, MainBizItemEntity entity, Bundle args, IRouterCallback callback) {
        callCommand(context, entity.getBundle(), RouterCommandType.TYPE_UI_COMMAND,
                entity.getCommand(), args, callback);
    }
}
