package com.pine.media.audio.widget;
...
import com.pine.media.audio.databinding.ApItemSimpleAudioDialogBinding;
import com.pine.media.audio.databinding.ApSimpleAudioDialogTitleBinding;
...
public abstract class AudioPlayerView extends RelativeLayout {
    ...
    protected int[] mPlayTypeResIds = {R.mipmap.ap_ic_play_order_1_1,
            R.mipmap.ap_ic_play_all_loop_1_1,
            R.mipmap.ap_ic_play_single_loop_1_1,
            R.mipmap.ap_ic_play_random_1_1};
    protected int[] mDialogPlayTypeResIds = {R.mipmap.ap_ic_play_order_1_2,
            ...
            mMusicListDialog = DialogUtils.createBottomCustomListDialog(RootApplication.mCurResumedActivity,
                    ...
                    new CustomListDialog.IOnViewBindCallback<ApMusic>() {
                        ...
                        public void onItemViewUpdate(View itemView, int position,
                            ...
                            if (playState == 2) {
                                binding.playStateIv.setImageResource(R.drawable.ap_anim_playing);
                                AnimationDrawable playAnim = (AnimationDrawable) binding.playStateIv.getDrawable();
                                playAnim.start();
                            } else {
                                binding.playStateIv.setImageResource(R.mipmap.ap_ic_playing_1_1);
                            }
