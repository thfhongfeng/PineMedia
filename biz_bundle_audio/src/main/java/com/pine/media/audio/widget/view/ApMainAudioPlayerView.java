...
public class ApMainAudioPlayerView extends AudioPlayerView {
    ...
    public ViewGroup initView() {
        ...
        mapv_loop_type_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onLoopTypeClick();
            }
        });
        mapv_media_list_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showMusicListDialog();
            }
        });
        mapv_favourite_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void setupPlayTypeImage(ApPlayListType playListType) {
        if (playListType == null) {
            mapv_loop_type_btn.setImageResource(R.mipmap.ap_ic_play_all_loop_1_1);
            return;
        }
    ...
    private void changeBgTheme(boolean isLightColor) {
        if (isLightColor) {
            mPlayTypeResIds = new int[]{R.mipmap.ap_ic_play_order_1_2,
                    R.mipmap.ap_ic_play_all_loop_1_2,
                    R.mipmap.ap_ic_play_single_loop_1_2,
                    R.mipmap.ap_ic_play_random_1_2};
            mapv_media_list_btn.setImageResource(R.mipmap.ap_ic_music_list_enable_1_2);
            mapv_favourite_btn.setImageResource(R.drawable.ap_selector_is_favourite_1_2);
            ...
            player_progress_bar.setThumb(getResources().getDrawable(R.drawable.ap_selector_seek_bar_thumb_1_2));
            player_progress_bar.setProgressDrawable(getResources().getDrawable(R.drawable.ap_shape_seek_bar_progress_2));
            player_pre_btn.setImageResource(R.drawable.ap_selector_previous_btn_1_2);
            player_play_pause_btn.setImageResource(R.drawable.ap_selector_play_pause_btn_big_1_2);
            player_next_btn.setImageResource(R.drawable.ap_selector_next_btn_1_2);
        } else {
            mPlayTypeResIds = new int[]{R.mipmap.ap_ic_play_order_1_1,
                    R.mipmap.ap_ic_play_all_loop_1_1,
                    R.mipmap.ap_ic_play_single_loop_1_1,
                    R.mipmap.ap_ic_play_random_1_1};
            mapv_media_list_btn.setImageResource(R.mipmap.ap_ic_music_list_enable_1_1);
            mapv_favourite_btn.setImageResource(R.drawable.ap_selector_is_favourite_1_1);
            ...
            player_progress_bar.setThumb(getResources().getDrawable(R.drawable.ap_selector_seek_bar_thumb_1_1));
            player_progress_bar.setProgressDrawable(getResources().getDrawable(R.drawable.ap_shape_seek_bar_progress_1));
            player_pre_btn.setImageResource(R.drawable.ap_selector_previous_btn_1_1);
            player_play_pause_btn.setImageResource(R.drawable.ap_selector_play_pause_btn_big_1_1);
            player_next_btn.setImageResource(R.drawable.ap_selector_next_btn_1_1);
        }
