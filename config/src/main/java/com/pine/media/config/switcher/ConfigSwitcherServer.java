package com.pine.media.config.switcher;

import com.pine.media.config.ConfigApplication;
import com.pine.media.config.ConfigKey;
import com.pine.media.config.bean.ConfigSwitcherEntity;
import com.pine.media.config.model.ConfigSwitcherModel;
...
public class ConfigSwitcherServer {
    ...
    private ConfigSwitcherServer() {
        synchronized (mGuestConfigStateMap) {
            ...
            mGuestConfigStateMap.put(ConfigKey.BUNDLE_VIDEO_PLAYER_KEY, true);
            mGuestConfigStateMap.put(ConfigKey.BUNDLE_AUDIO_PLAYER_KEY, true);
            mGuestConfigStateMap.put(ConfigKey.BUNDLE_PICTURE_VIEWER_KEY, true);
        }
