package com.pine.media.base.component.image_loader.glide.loader;
...
public class HttpRequestLoader implements ModelLoader<GlideUrl, InputStream> {
    ...
    public static final Option<Integer> TIMEOUT = Option.memory(
            "com.pine.media.base.component.image_loader.glide.model_loader.HttpRequestLoader.Timeout", 2500);
