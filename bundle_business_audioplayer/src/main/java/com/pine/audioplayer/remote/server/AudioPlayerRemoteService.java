...
import com.pine.audioplayer.ui.activity.AudioPlayerHomeActivity;
...
public class AudioPlayerRemoteService {
    ...
    public void goAudioPlayerHomeActivity(@NonNull Context context, Bundle args, @NonNull final IServiceCallback callback) {
        ...
        Intent intent = new Intent(context, AudioPlayerHomeActivity.class);
